...
import it.unitn.disi.sweng.secbpmn.model.Auditability;
import it.unitn.disi.sweng.secbpmn.model.TaskType;

public class AuditabilityInference implements SecurityAnnotationInference {
	...
	public void infer(GMTNode node, HashMap<String, List<Combination>> inferredValues, List<ConsoleMessage> messages) {
		if (node instanceof Auditability) {
