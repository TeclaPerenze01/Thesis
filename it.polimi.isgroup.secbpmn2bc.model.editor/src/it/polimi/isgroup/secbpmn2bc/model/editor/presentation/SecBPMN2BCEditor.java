...
import it.polimi.isgroup.secbpmn2bc.model.edit.provider.SecBPMN2BCItemProviderAdapterFactory;
...
/**
 * This is an example of a SecBPMN2BC model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class SecBPMN2BCEditor extends MultiPageEditorPart
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(SecBPMN2BCModelWizard.FILE_EXTENSIONS,
			"*."); //$NON-NLS-1$
		...
		public void partActivated(IWorkbenchPart p) {
			if (p instanceof ContentOutline) {
				if (((ContentOutline) p).getCurrentPage() == contentOutlinePage) {
					getActionBarContributor().setActiveEditor(SecBPMN2BCEditor.this);
			...
			} else if (p == SecBPMN2BCEditor.this) {
				handleActivate();
			}
		}
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(SecBPMN2BCEditor.this, false);
			} else {
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic = new BasicDiagnostic(Diagnostic.OK, "it.polimi.isgroup.secbpmn2bc.model.editor", //$NON-NLS-1$
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new SecBPMN2BCItemProviderAdapterFactory());
		adapterFactory.addAdapterFactory(new SecBPMNItemProviderAdapterFactory());
		adapterFactory.addAdapterFactory(new GMTItemProviderAdapterFactory());
	...
	public Diagnostic analyzeResourceProblems(Resource resource, Exception exception) {
		...
		if (hasErrors || !resource.getWarnings().isEmpty()) {
			BasicDiagnostic basicDiagnostic = new BasicDiagnostic(hasErrors ? Diagnostic.ERROR : Diagnostic.WARNING,
					"it.polimi.isgroup.secbpmn2bc.model.editor", //$NON-NLS-1$
					0, getString("_UI_CreateModelError_message", resource.getURI()), //$NON-NLS-1$
					new Object[] { exception == null ? (Object) resource : exception });
			basicDiagnostic.merge(EcoreUtil.computeDiagnostic(resource, true));
			return basicDiagnostic;
		} else if (exception != null) {
			return new BasicDiagnostic(Diagnostic.ERROR, "it.polimi.isgroup.secbpmn2bc.model.editor", //$NON-NLS-1$
					0, getString("_UI_CreateModelError_message", resource.getURI()), //$NON-NLS-1$
	...
	public void createPages() {
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane = new ViewerPane(getSite().getPage(), SecBPMN2BCEditor.this) {
					@Override
				...
				selectionViewer.setLabelProvider(
						new DecoratingColumLabelProvider(new AdapterFactoryLabelProvider(adapterFactory),
								new DiagnosticDecorator(editingDomain.getResourceSet(), selectionViewer)));
			...
			//
			{
				...
				treeViewer.setLabelProvider(
						new DecoratingColumLabelProvider(new AdapterFactoryLabelProvider(adapterFactory),
								new DiagnosticDecorator(editingDomain.getResourceSet(), treeViewer)));
			...
			//
			{
				...
				tableViewer.setLabelProvider(
						new DecoratingColumLabelProvider(new AdapterFactoryLabelProvider(adapterFactory),
								new DiagnosticDecorator(editingDomain.getResourceSet(), tableViewer)));
			...
			//
			{
				...
				treeViewerWithColumns.setLabelProvider(
						new DecoratingColumLabelProvider(new AdapterFactoryLabelProvider(adapterFactory),
								new DiagnosticDecorator(editingDomain.getResourceSet(), treeViewerWithColumns)));
			...
			class MyContentOutlinePage extends ContentOutlinePage {
				...
				public void createControl(Composite parent) {
					...
					contentOutlineViewer.setLabelProvider(
							new DecoratingColumLabelProvider(new AdapterFactoryLabelProvider(adapterFactory),
									new DiagnosticDecorator(editingDomain.getResourceSet(), contentOutlineViewer)));
	...
	public IPropertySheetPage getPropertySheetPage() {
		PropertySheetPage propertySheetPage = new ExtendedPropertySheetPage(editingDomain,
				ExtendedPropertySheetPage.Decoration.MANUAL) {
			@Override
			public void setSelectionToViewer(List<?> selection) {
				SecBPMN2BCEditor.this.setSelectionToViewer(selection);
				SecBPMN2BCEditor.this.setFocus();
			}
	...
	public void doAnnotate() {
		for (Resource resource : editingDomain.getResourceSet().getResources()) {
			...
			if (p.checkForErrors(log)) {
				MessageDialog.openError(getSite().getShell(), "Annotate with BC properties", 
				...
				MessageDialog.openWarning(getSite().getShell(), "Annotate with BC properties", 
						"Model annotation completed with warnings. Please check the console log for further details.");
			} else {
	...
	public void doSaveAs() {
		...
		String[] files = Secbpmn2bcEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
